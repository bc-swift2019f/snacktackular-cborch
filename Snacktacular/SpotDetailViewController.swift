...
class SpotDetailViewController: UIViewController {
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Neen Saved", message: "You must save this venue before you can add a photot.", segueIdentifier: "AddPhoto")
        } else {
    ...
    @IBAction func reviewButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Neen Saved", message: "You must save this venue before you can review it.", segueIdentifier: "AddReview")
        } else {
